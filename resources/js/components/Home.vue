        ...
        <div class="mt-16">
            <div class="row justify-space-between">
                <div class="col-md-3 d-none d-md-block flex justify-center">
                    <div class="fixed sidebar-content left-0">
                        <div class="">
                            <div class="flex justify-center pt-5">
                                <img class="w-40 h-40 rounded-circle object-cover" :src="`${ user.avatar != 'avatar.png' ? `storage/users-avatar/${user.avatar}` : 'images/avatar.png' }`"/>
                            </div>
                            <div class="flex font-bold text-lg justify-center py-3 capitalize">{{ user.name }}</div>
                            ...
                            <a href="/myprofile" class="py-3 flex justify-center cursor-pointer text-md text-blue-700 font-bold">View My Profile</a>
                        </div>
                        
                        <div v-if="suggested_friends.length" class="py-3 my-3">
                            ...
                            <div class="flex justify-between px-3 pt-3" v-for="suggested in suggested_friends" :key="suggested.id">
                                <div class="flex">
                                    <div class="pr-2">
                                        <img class="w-8 h-8 rounded-circle object-cover" :src="`${ suggested.avatar != 'avatar.png' ? `storage/users-avatar/${suggested.avatar}` : 'images/avatar.png' }`"/>
                                    </div>
                                    <div class="pt-1 font-semibold capitalize">{{ suggested.name }}</div>
                                </div>
                                <div>
                                    <v-tooltip
                                        location="bottom"
                ...
                <div class="col-12 col-md-6 body-center-content">
                ...
                <div class="col-md-3 d-none d-md-block">
                    <div class="fixed sidebar-content screen-height overflow-auto right-0">
                        <div class="p-3 my-3">
                        ...
                        <div v-if="friends.length" class="py-3 my-3">
                            <div class="font-bold border-b-2">
...
export default {
    ...
    methods: {
        async myprofile(){
            await axios.get('/myprofile').then(res=>{
        ...
        async submitAsk() {
            const configuration = new Configuration({
                apiKey: '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', //process.env.OPENAI_API_KEY,
            });
        ...
        async convertImage() {
            const configuration = new Configuration({
                apiKey: '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',//process.env.OPENAI_API_KEY,
            });
            let openai = new OpenAIApi(configuration);
